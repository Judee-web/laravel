...
<head>
	...
	<!-- PAGE TITLE HERE -->
	<title>CitizensAssetBank : Dashboard</title>
            ...
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-cash-stack" viewBox="0 0 16 16">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="table-bootstrap-basic.html">All Loans</a></li>
                            <li><a href="table-datatable-basic.html">Active Loans</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./form-element.html">Email Support</a></li>
                            <li><a href="./form-wizard.html">Livechat</a></li>
                            <li><a href="./form-ckeditor.html">inbox</a></li>
